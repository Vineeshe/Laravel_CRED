  ...
  <div class="container">
    <form action="{{$url}}"  method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="username" name="name" value= {{$customer_edt->name}}>
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="email" name="email"  value= {{$customer_edt->email}}>
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" id="password" name="password"  value= {{$customer_edt->password}}>
